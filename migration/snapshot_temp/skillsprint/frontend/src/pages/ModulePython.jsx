...
export default function ModulePython() {
  const levels = [
    { key: "beginner", title: "Beginner", desc: "Start here to warm up your fundamentals." },
    { key: "intermediate", title: "Intermediate", desc: "Level up with practical problem-solving." },
    { key: "expert", title: "Expert", desc: "Challenge yourself with advanced scenarios." },
  ];

  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 dark:text-slate-100">Python Module</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {levels.map((lvl) => (
          <div key={lvl.key} className="module-card flex flex-col">
            ...
            <Link to={`/modules/python/${lvl.key}`} className="btn-primary mt-6">Start</Link>
          </div>
        ))}
      </div>
    </div>
